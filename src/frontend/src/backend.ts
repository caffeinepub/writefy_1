...
export class Backend implements backendInterface {
    ...
    async createDocument(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
    ...
    async getAllDocumentsMeta(): Promise<Array<DocumentMeta>> {
        if (this.processError) {
            try {
    ...
    async getDocumentMeta(arg0: string): Promise<DocumentMeta> {
        if (this.processError) {
            try {
    ...
    async updateDocument(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
